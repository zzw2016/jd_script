...
`)
  ...
  $.InviteLists = []
  if (HelpAuthorFlag) {
    $.innerInviteList = await getAuthorShareCode('https://www.azurew.com/wealth_island_code_one.json');
    res2 = await getAuthorShareCode('https://www.azurew.com/wealth_island_code_one.json');
