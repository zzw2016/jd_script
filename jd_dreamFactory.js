...
async function joinLeaderTuan() {
  let res = await updateTuanIdsCDN('https://www.azurew.com/jd_updateFactoryTuanId.json')
  if (!res) res = await updateTuanIdsCDN('https://www.azurew.com/jd_updateFactoryTuanId.json')
